...
import 'package:snapchatClone/screens/home/profile/my_story_img_prev.dart';
import 'package:snapchatClone/screens/home/profile/my_story_vid_prev.dart';
import 'package:path/path.dart';
import 'package:camera/camera.dart';
import 'package:path_provider/path_provider.dart';

class AddToMyStory extends StatefulWidget {
  final double statusBar;
  AddToMyStory({this.statusBar});
  @override
  _AddToMyStoryState createState() => _AddToMyStoryState();
}

class _AddToMyStoryState extends State<AddToMyStory> {
  ...
  void _onCapturePressed(context) async {
    try {
      ...
      Navigator.push(
        context,
        MaterialPageRoute(builder: (context) => MyStoryImagePrev(imgPath: path)),
      );
    } catch (e) {
  ...
  void _onVideoStopRecording(context) async {
    ...
    try {
      ...
      Navigator.push(
        context,
        MaterialPageRoute(builder: (context) => MyStoryVideoPrev(imgPath: thePath)),
      );
    } catch (e) {
      ...
      title: Container(
        ...
        Container(
            ...
            child: Center(
              ...
              Container(
                child: Text('Add to', style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold, color: Colors.white)),
              ),
              Container(
                child:
                    Text('My Story', style: TextStyle(fontSize: 16, fontWeight: FontWeight.w400, color: Colors.white)),
              )
            ]))),
        Align(
