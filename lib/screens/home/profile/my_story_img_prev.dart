...
class MyStoryImagePrev extends StatefulWidget {
  final String imgPath;
  MyStoryImagePrev({this.imgPath});

  @override
  _MyStoryImagePrevState createState() => _MyStoryImagePrevState();
}

class _MyStoryImagePrevState extends State<MyStoryImagePrev> {
